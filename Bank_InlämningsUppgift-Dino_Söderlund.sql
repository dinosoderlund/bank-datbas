...
USE master;
GO
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'Bank_Databas')
BEGIN
    ALTER DATABASE Bank_Databas SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE Bank_Databas;
END
...
(1, 1, '2024-04-18 08:00:00', '2024-04-18 01:32:00', 'iPhone 10'),
(2, 2, '2024-01-19 09:00:00', '2024-01-19 08:31:00', 'PC Windows 10'),
(3, 3, '2024-02-20 08:00:00', '2024-02-20 07:25:00', 'iPhone 11'),
(4, 4, '2024-03-21 09:00:00', '2024-03-21 06:10:00', 'PC Windows 10'),
(5, 5, '2024-05-22 08:00:00', '2024-05-22 05:15:00', 'iPhone 9'),
(6, 6, '2024-10-23 09:00:00', '2024-10-23 04:10:00', 'PC Windows 13'),
(7, 7, '2024-11-25 08:00:00', '2024-11-25 03:12:00', 'Samsung Galaxy S9'),
(8, 8, '2024-12-21 09:00:00', '2024-12-21 02:23:00', 'PC Windows 10'),
(9, 9, '2024-11-28 08:00:00', '2024-11-28 09:21:00', 'Macbook'),
(10, 10, '2024-10-02 09:00:00', '2024-10-02 01:30:00', 'PC Windows 11')
